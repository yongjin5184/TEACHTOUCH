...
var draw = {
	...
	start : function(e){
		ctx.beginPath(); 
		ctx.moveTo(e.pageX-offX,e.pageY-offY);
		this.drawing = true;

		//		msg.line.send('start',e.pageX-offX,e.pageY-offY);
		msg.line.send('start',(e.pageX-offX)*0.4,(e.pageY-offY)*0.35);
	},
	
	move : function(e){
		if(this.drawing){
			ctx.lineTo(e.pageX-offX,e.pageY-offY);
			ctx.stroke();
			//			msg.line.send('move',e.pageX-offX,e.pageY-offY);
			msg.line.send('move',(e.pageX-offX)*0.4,(e.pageY-offY)*0.35);
		}
